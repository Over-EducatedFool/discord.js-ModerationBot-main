...
client.on("ready", async () => {
  console.log(`Yo boii!! Moderation.V1 has been deployed!! Coded by Over-Educated Fool`);
  client.user
    .setActivity(`Doraemon`, { type: "WATCHING" })
...
//Bot Coded by Over-Educated Fool DONOT share WITHOUT credits!!